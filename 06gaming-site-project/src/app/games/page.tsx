        ...
        {games.map((game) => (
          ...
          >
            <div className="relative">
              <img
                className="w-full h-52 object-cover rounded-lg opacity-50 group-hover:opacity-100 transition"
                src={game.image}
                alt={game.title}
              />
              <div className="absolute inset-0 bg-opacity-30 rounded-lg opacity-0 group-hover:opacity-100 transition"></div>
            </div>
